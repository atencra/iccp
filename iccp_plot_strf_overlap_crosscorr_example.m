function iccp_plot_strf_overlap_crosscorr_example(strf, trigger, ccpairs)
% iccp_plot_strf_overlap_crosscorr_example STRF overlap for two neurons
% 
%     iccp_plot_strf_overlap_crosscorr_example(strf, trigger, ccpairs)
%     ------------------------------------------------------------------
% 
...
%*********************************************************************
% Will need to reverse this - get STRFs for cross-covariance function pair
%*********************************************************************
    ...
    %     legend('STRF Overlap', 'Spike Train Corr');
        ...
        suptitle(sprintf('%s-site%.0f-chan%.0f model %.0f/%.0f %s', ...
        cc.exp, cc.site, cc.chan, cc.model1(1), cc.model2(1), cc.stim));

%         set(gcf,'position', [417 380 665 602]);
