function iccpairs_folder_fix_fra_spk_isi
% iccpairs_fix_fra_spk_isi Modify spike train files so no ISIs < 0.5 ms
% 
%     iccpairs_fix_fra_spk_isi
% 
...
d = dir( sprintf('*-fracmb-pairs.mat') );
...
for i = 1:length(d)
    ...
    outfile = sprintf('%s-isi-fixed.mat', infile(1:index-1));
...
%     [fra] = freq_resp_area(spk, trigger, center, range, nreps);
    ...
    save(outfile, 'fra', 'spk', 'trigger');
    clear('spk', 'fra', 'trigger', 'spknew');
