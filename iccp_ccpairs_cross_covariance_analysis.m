...
% iccp_ccpairs_cross_covariance_analysis  Analyze cross-cov function
%
%    ccpairs_new = iccp_ccpairs_cross_covariance_analysis(ccpairs)
%
%    Reanalyzes cross-covariance functions in ccpairs so that positive and
%    negative peaks are evaluated. Why? Because the positive peaks
%    represent neural excitation, while the negative peaks represent
%    suppression. It is likely, then, that the characteristics of each type
%    of peak are different.
%
