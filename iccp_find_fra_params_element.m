function index = iccp_find_fra_params_element(params, exp, site, chan, model, stim)
% iccp_find_fra_params_element Index to struct array element for experiment specs
% 
