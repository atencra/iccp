function [mtfdata] = iccp_ccpairs_select_max_strf_bmf(mtfdata)
% iccpairs_ccpairs_select_max_plot_strf_params STRF params for synchronous spikes
%
% [mtfdata] = iccpairs_ccpairs_select_max_plot_strf_ptparams;
% iccpairs_ccpairs_select_max_plot_strf_params(mtfdata)
% --------------------------------------------------------
