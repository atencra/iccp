function iccpairs_folder_select_synchronous_ccpairs(basename)
%iccpairs_folder_select_synchronous_ccpairs Identify sharply synchronous
...
% 
%   iccpairs_folder_select_synchronous_ccpairs(basename)
