function iccp_batch_calc_info_isi_fixed_crosscorr
% iccp_batch_calc_info_isi_fixed_crosscorr Correlation between pairs of neurons for repeated ripple stimuli
%
%     iccp_batch_calc_info_isi_fixed_crosscorr
%     --------------------------------------------------------
% 
...
% 
%     The function processes all '*-dmrrep-fs18115-%s-isi-fixed.mat' files
%     in the current directory using the function calls:
% 
