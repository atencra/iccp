function dataFolder = iccp_dir_from_spk(spk)
% iccp_dir_from_spk Construct ICC relative directory structure from data struct
% 
%     dataFolder = iccp_dir_from_spk(spk)
% 
