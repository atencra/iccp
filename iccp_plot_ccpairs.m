function iccp_plot_ccpairs(ccpairs)
% iccp_plot_ccpairs Show functional connectivity metrics
% 
%     iccp_plot_ccpairs(ccpairs) plots the correlogram, cross-covariance
