function iccp_folder_select_synchronous_ccpairs_max(basename)
%iccp_folder_select_synchronous_ccpairs_max Identify sharply synchronous
%neuron pairs in files
%
%   index = iccp_folder_select_synchronous_ccpairs(basename)
%
