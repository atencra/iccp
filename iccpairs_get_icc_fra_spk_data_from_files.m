function [pairstrains] = iccpairs_get_icc_fra_spk_data_from_files
% iccpairs_get_icc_fra_spk_data_from_files Pairs from channels of spk and fra data
% 
%     [pairstrains] = iccpairs_get_icc_fra_spk_data_from_files;
% 
