function newpairs = iccpairs_combine_ccpairs_fiopairs(ccpairs, fiopairs)
% iccpairs_combine_ccpairs_fiopairs Correlation between pairs
%
% iccpairs_combine_ccpairs_fiopairs(ccpairs, fiopairs)
% -----------------------------------------------------------
%
